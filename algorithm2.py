    ...
    while True:
        ...
        while iter < max_merge_iter:
            ...
            while True:
                ...
                bundle1 = select_two_bundles(all_bundles)[0]
                ...
                if new_bundle is not None:
                    if (new_bundle.rider.calculate_cost(new_bundle.total_dist) < bundle1.rider.calculate_cost(bundle1.total_dist) + bundle2.rider.calculate_cost(bundle2.total_dist)) and new_bundle.total_dist <= mean_dist * 10:
                        break
